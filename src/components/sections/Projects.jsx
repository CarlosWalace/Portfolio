  ...
  const projects = [
    {
      ...
      description: "Full-featured online store com gerenciamento de produtos, carrinho e checkout.",
      images: [
        { src: img1, title: "Account Creation" },
        { src: img2, title: "Create a New Event" },
        { src: img3, title: "Profile Editing" },
        { src: img4, title: "Event Dashboard" },
        { src: img5, title: "Create a New Event" },
        { src: img6, title: "Event Editing" },
        { src: img7, title: "V-LIBRAS Working" },
      ],
      link: "#",
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-center mb-3">
                    <button
                      ...
                      className={`px-3 py-1 text-xs rounded-l-lg transition-all ${activeTabs[projectIndex] === 'frontend'
                    ...
                    <button
                      ...
                      className={`px-3 py-1 text-xs rounded-r-lg transition-all ${activeTabs[projectIndex] === 'backend'
                        ? 'bg-blue-500 text-white'
                        : 'bg-blue-500/20 text-blue-400 hover:bg-blue-500/30'
                        }`}
                    >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {getTotalTechPages(projectIndex) > 1 && (
                        <button
                          ...
                          className="absolute left-0 z-10 bg-blue-500/20 hover:bg-blue-500/30 p-1 rounded-full transition-all transform -translate-y-1/2 top-1/2"
                          aria-label="Previous technologies"
                        >
                          <IoIosArrowBack className="text-blue-400 text-sm" />
                        </button>
                      )}
                      ...
                      <div className="flex justify-center space-x-3 py-2 px-8 w-full transition-all duration-300">
                        {getVisibleTechnologies(projectIndex).map((tech, index) => (
                          <div
                            key={index}
                            className="flex flex-col items-center justify-center bg-blue-500/10 p-2 rounded-lg w-[70px] h-[70px] 
                      ...
                      {getTotalTechPages(projectIndex) > 1 && (
                        <button
                          ...
                          className="absolute right-0 z-10 bg-blue-500/20 hover:bg-blue-500/30 p-1 rounded-full transition-all transform -translate-y-1/2 top-1/2"
                          aria-label="Next technologies"
                        >
                          <IoIosArrowForward className="text-blue-400 text-sm" />
                        </button>
                      )}
                    </div>
                      ...
                      <div className="flex justify-center mt-2 space-x-1">
                        {Array.from({ length: getTotalTechPages(projectIndex) }).map((_, index) => (
                          <button
                            ...
                            className={`w-1.5 h-1.5 rounded-full transition-all ${currentTechIndices[projectIndex] === index ? 'bg-blue-500 w-4' : 'bg-gray-500'
                              }`}
